  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      >
        ...
        <List>
          {["Sản phẩm", "Đơn hàng", "Người dùng", "Thống kê"].map((text, index) => (
      ...
      >
        <Box sx={{ borderBottom: 1, 
          ...
          <Tabs value={value} onChange={handleChange} aria-label="basic tabs example" textColor="inherit" indicatorColor="secondary">
            ...
            <Tab label="Thêm/ Sửa sản phẩm" {...a11yProps(1)} />
          </Tabs>
        </Box>
      </Box>)}
      { idx === 1 &&
        ...
        >
          <Box sx={{ borderBottom: 1, 
            ...
            <Tabs
              ...
              value={value}
            >
              <Tab value={6} label="Danh sách người dùng" {...a11yProps(6)} />
            </Tabs>
          </Box>
        </Box>
      )}
