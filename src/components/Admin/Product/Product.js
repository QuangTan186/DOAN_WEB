...
function Product(props) {
    ...
    const [idCate, setIdCate] = React.useState(paramsa.icate);
    ...
    const handleOnChangePaging = (value) =>{
        dispatch({
            type: ProductAction.GET_LIST_PRODUCT,
            data: {
        ...
        <div className={styles.admin}>
            ...
            >
                ...
                <div style={{ height: '300px', marginTop: '20px'}}>
                    <Pagination count={totalPage} onChange={(event, value) => {handleOnChangePaging(value)}} color="primary" style={{marginRight: 'auto'}}/>
                </div>
            </div>
