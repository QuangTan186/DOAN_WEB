...
const GetListUserFactory = {
    requestGetListUser: (data) => 
        ApiOperation.request({
            url: ApiConstants.GET_LIST_USER,
            method: 'GET',
        })
}
...
export { LoginFactory, RegisterFactory, GetUserFactory, ChangeProfileFactory, ChangePasswordFactory, GetIsAdminFactory, GetListUserFactory } 